...
(function (factory) {
    ...
    $.fn.rating.defaults = {
        ...
        language: 'en',
        stars: 5,
        filledStar: '<i class="glyphicon glyphicon-star" aria-hidden="true"></i>',
        emptyStar: '<i class="glyphicon glyphicon-star-empty" aria-hidden="true"></i>',
        containerClass: '',
        size: 'md',
        animate: true,
        displayOnly: false,
        ...
        clearButton: '<i class="glyphicon glyphicon-minus-sign" aria-hidden="true"></i>',
