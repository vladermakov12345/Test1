module.exports = function(app) {
    var supportController = function ($rootScope,dataFactory,environmentService) {
        ...
        function init() {
            ...
            //setup meta tags
            var title = 'Customer Support';
            var desc = 'Customer Support Desk';
    ...
    supportController.$inject = ['$rootScope','dataFactory','environmentService'];
